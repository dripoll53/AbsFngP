...
TRAIN_DIR = "/home_USER/AbsFngP/DNN/Specificity/EBOV/EBV3Sites/data1/train/"
...
VALID_DIR = "/home_USER/AbsFngP/DNN/Specificity/EBOV/EBV3Sites/data1/valid/"
...
TEST_DIR = "/home_USER/AbsFngP/DNN/Specificity/EBOV/EBV3Sites/data1/test/"
...
filepathOut="./checkpoints/" + "ResNet50" +  "_model.h5"
...
results.to_csv("results-A3sites.csv",index=False)
